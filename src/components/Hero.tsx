      ...
      >
        ...
        >
          ...
          <span className="inline-block relative" style={{ minWidth: "4.5ch" }}>
            ...
            <span className="invisible absolute left-0" aria-hidden="true">{t(translations.hero.longestWord)}</span>
          </span>
        </motion.h1>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 py-8">
              ...
              <div className="flex-1 max-w-[200px] w-full">
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg px-5 py-4 text-center">
                  ...
                  <div className="text-sm font-medium text-foreground">{t(translations.hero.newEvent)}</div>
                </div>
              </div>

              {/* Arrow */}
              <div className="text-muted-foreground text-xl hidden md:block">→</div>
              ...
              <div className="flex-1 max-w-[200px] w-full">
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg px-5 py-4 text-center">
                  ...
                  <div className="text-sm font-medium text-foreground">{t(translations.hero.aiAgent)}</div>
                </div>
              </div>
              ...
              <div className="flex-1 max-w-[200px] w-full">
                <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg px-5 py-4 text-center">
                  ...
                  <div className="text-sm font-medium text-foreground">{t(translations.hero.execute)}</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">{t(translations.hero.agentsActive)}</span>
              </div>
              <span className="text-xs text-primary font-medium">{t(translations.hero.allRunning)}</span>
            </div>
          </motion.div>
        </motion.div>
      </motion.div>
